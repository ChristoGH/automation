...
# owls_members_df=owls_members_df[['policy_policynumber','policy_grosspremium','policy_status','policy_totalpremium','productsetup_productsetupname','policy_inceptiondate']].copy()
# ----------------------------------------------------------------------------------------------------------------------------
...
# df1=owls_received_claims_df.merge(owls_members_df[['policy_policynumber','corporate_individual']], left_on= 'policy_policynumber_a', right_on='policy_policynumber', how='left')
...
for product in product_list:
    ...
    # owls_members_df=owls_members_df[['policy_policynumber','policy_grosspremium','policy_status','policy_totalpremium','productsetup_productsetupname','policy_inceptiondate']].copy()
    # owls_terminations_df=owls_terminations_df[['policy_policynumber','policy_totalpremium','productsetup_productsetupname','policy_inceptiondate','policy_cancellationdate']].copy()
    ...
    for i in range(1,len(iterate_months)-1):
        ...
        identifier_name=period="subsequent_new_policies"+ '_'+str(iterate_months[i].year)+str(iterate_months[i].month)
        slice_saver(identifier_name=identifier_name, dataframe=new_policies_df, save_path=slices_path, datafile_name=owls_members, product_name=product)
        ...
        identifier_name=period="sebsequent_valid_terminations"+ '_'+str(iterate_months[i].year)+str(iterate_months[i].month)
        slice_saver(identifier_name=identifier_name, dataframe=valid_terminations_df, save_path=slices_path, datafile_name=owls_members, product_name=product)
    ...
    #   ----------------------------------------------------------------------------------------------------------------------------
        ...
        identifier_name=period="period_new_policies"+ '_'+str(iterate_months[i].year)+str(iterate_months[i].month)
        slice_saver(identifier_name=identifier_name, dataframe=new_policies_df, save_path=slices_path, datafile_name=owls_members, product_name=product)
    ...
    for i in range(1,len(iterate_months)-1):
        ...
        identifier_name=period="period_ntu"+ '_'+str(iterate_months[i].year)+str(iterate_months[i].month)
    ...
    for i in range(1,len(iterate_months)-1):
        ...
        identifier_name=period="period_cancellations"+ '_'+str(iterate_months[i].year)+str(iterate_months[i].month)
    ...
    #     last_day_of_month=last_day_of_month_fn(iterate_months[i])
        ...
        identifier_name=period="period_claims_received"+ '_'+str(iterate_months[i].year)+str(iterate_months[i].month)
        
        slice_saver(identifier_name=identifier_name, dataframe=df, save_path=slices_path, datafile_name=owls_members, product_name=product)
    ...
    #     last_day_of_month=last_day_of_month_fn(iterate_months[i])
        ...
        df=owls_received_claims_df[f].copy()
        identifier_name=period="period_claims_paid"+ '_'+str(iterate_months[i].year)+str(iterate_months[i].month)
    ...
    #     last_day_of_month=last_day_of_month_fn(iterate_months[i])
        ...
        df=owls_received_claims_df[f].copy()
        identifier_name=period="period_claims_rejected"+ '_'+str(iterate_months[i].year)+str(iterate_months[i].month)
    ...
    #     last_day_of_month=last_day_of_month_fn(iterate_months[i])
        ...
        df=owls_received_claims_df[f].copy()
        identifier_name=period="period_claims_outstanding"+ '_'+str(iterate_months[i].year)+str(iterate_months[i].month)
